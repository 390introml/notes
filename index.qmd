---
include-before-body: assets/pre-title.html
...
-   The data are generated by a Markov chain (i.e. outputs only depend on the current *state*, with no additional *memory*).
