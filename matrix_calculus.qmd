...
You may be wondering why we are forcibly—and somewhat confusingly—adding this transpose to the definition. This is a specific choice we made, and some textbooks prefer the Numerator Layout notation. However, we will stick with the denominator layout since it simplifies the calculations later on. This denominator layout convention has been adopted by the field of machine learning to ensure that the shape of the gradient is the same as the shape of the respective parameter.
