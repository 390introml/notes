...
\begin{tikzpicture}[scale=0.6, background rectangle/.style={fill=white},
  ...
  % Arrows from image to filters
  \coordinate (x) at (4.2, 2);
  \foreach \yoff in {-1.2,-0.4,0.4,1.2} {
      \draw[->,thick] (x) -- ++(1.5,\yoff);
    }

  % Filter bank - 4 different filters
  \begin{scope}[xshift=7cm]
    \foreach \i/\c/\label in {0/blue/Filter 1,1/red/Filter 2,2/green/Filter 3,3/purple/Filter 4} {
        \begin{scope}[xshift=0, yshift=\i*1.2cm]
          \draw[step=4mm, color=\c, thick] (0,0) grid (2,2);
          \draw[black,very thick] (0,0) rectangle (2,2);
          \node[below, color=\c] at (1,-0.3) {\label};
        \end{scope}
      }
  \end{scope}

  % Arrows from filters to feature maps
  \coordinate (y) at (9.2, 2);
  \foreach \yoff in {-1.2,-0.4,0.4,1.2} {
      \draw[->,thick] (y) -- ++(1.5,\yoff);
    }

  % Feature maps (output channels)
  \begin{scope}[xshift=12cm]
    \foreach \i/\c/\label in {0/blue/Channel 1,1/red/Channel 2,2/green/Channel 3,3/purple/Channel 4} {
        \begin{scope}[xshift=0, yshift=\i*1.2cm]
          \draw[step=3mm, color=\c, thin] (0,0) grid (3,3);
          \draw[black,very thick] (0,0) rectangle (3,3);
          \node[below, color=\c] at (1.5,-0.3) {\label};
        \end{scope}
      }
  \end{scope}

  % Label for the whole process
  \node[above] at (6,4.5) {Filter Bank};
  \node[above] at (10.5,4.5) {Feature Maps};
\end{tikzpicture}
:::
...
\begin{tikzpicture}[scale=0.4, background rectangle/.style={fill=white}, show background rectangle]
  \begin{scope}
    ...
    % Fill black cells and add labels
    ...
    \node at (5.5,0.5) {0}; \node at (5.5,1.5) {0}; \node at (5.5,2.5) {0};
    \node at (5.5,3.5) {0}; \node at (5.5,4.5) {0}; \node at (5.5,5.5) {0};
    \draw[->,thick] (6.5,3) -- (8.2, 1.5);
    \draw[->,thick] (6.5,3) -- (8.2, 4.5);
    \begin{scope}[xshift=8.2cm,yshift=4.5cm]
      \draw[black,thick] (0,0) grid (3,3);
      \draw[black,very thick] (0,0) rectangle (3,3);
      % Fill black cells and add labels for f2 (horizontal)
      ...
      \node[left] at (0,1.5) {$f_2$ (horizontal)};
    \end{scope}
    \begin{scope}[xshift=8.2cm,yshift=1.5cm]
      \draw[black,thick] (0,0) grid (3,3);
      \draw[black,very thick] (0,0) rectangle (3,3);
      % Fill black cells and add labels for f1 (vertical)
      ...
      \node[left] at (0,1.5) {$f_1$ (vertical)};
    \end{scope}
  \end{scope}
  \begin{scope}[xshift=14cm, yshift=6cm]
    \draw[black,thick] (0,0) grid (6,6);
    \draw[black,very thick] (0,0) rectangle (6,6);
    % Add numerical convolution results for f1 (vertical detector)
    \node at (0.5,0.5) {2}; \node at (1.5,0.5) {2}; \node at (2.5,0.5) {0}; \node at (3.5,0.5) {0}; \node at (4.5,0.5) {0}; \node at (5.5,0.5) {0};
    \node at (0.5,1.5) {3}; \node at (1.5,1.5) {3}; \node at (2.5,1.5) {0}; \node at (3.5,1.5) {0}; \node at (4.5,1.5) {0}; \node at (5.5,1.5) {0};
    \node at (0.5,2.5) {1}; \node at (1.5,2.5) {1}; \node at (2.5,2.5) {2}; \node at (3.5,2.5) {1}; \node at (4.5,2.5) {2}; \node at (5.5,2.5) {0};
    \node at (0.5,3.5) {0}; \node at (1.5,3.5) {0}; \node at (2.5,3.5) {2}; \node at (3.5,3.5) {1}; \node at (4.5,3.5) {2}; \node at (5.5,3.5) {0};
    \node at (0.5,4.5) {0}; \node at (1.5,4.5) {0}; \node at (2.5,4.5) {1}; \node at (3.5,4.5) {1}; \node at (4.5,4.5) {1}; \node at (5.5,4.5) {0};
    \node at (0.5,5.5) {0}; \node at (1.5,5.5) {0}; \node at (2.5,5.5) {0}; \node at (3.5,5.5) {0}; \node at (4.5,5.5) {0}; \node at (5.5,5.5) {0};
    \draw[->,thick] (3.2, 1.5) -- (5.2, 1.5);
  \end{scope}
  \begin{scope}[xshift=14cm, yshift=-6cm]
    \draw[black,thick] (0,0) grid (6,6);
    \draw[black,very thick] (0,0) rectangle (6,6);
    % Add numerical convolution results for f2 (horizontal detector)
    \node at (0.5,0.5) {0}; \node at (1.5,0.5) {0}; \node at (2.5,0.5) {0}; \node at (3.5,0.5) {0}; \node at (4.5,0.5) {0}; \node at (5.5,0.5) {0};
    \node at (0.5,1.5) {0}; \node at (1.5,1.5) {0}; \node at (2.5,1.5) {0}; \node at (3.5,1.5) {0}; \node at (4.5,1.5) {0}; \node at (5.5,1.5) {0};
    \node at (0.5,2.5) {0}; \node at (1.5,2.5) {0}; \node at (2.5,2.5) {2}; \node at (3.5,2.5) {1}; \node at (4.5,2.5) {2}; \node at (5.5,2.5) {0};
    \node at (0.5,3.5) {0}; \node at (1.5,3.5) {0}; \node at (2.5,3.5) {2}; \node at (3.5,3.5) {1}; \node at (4.5,3.5) {2}; \node at (5.5,3.5) {0};
    \node at (0.5,4.5) {0}; \node at (1.5,4.5) {0}; \node at (2.5,4.5) {1}; \node at (3.5,4.5) {1}; \node at (4.5,4.5) {1}; \node at (5.5,4.5) {0};
    \node at (0.5,5.5) {0}; \node at (1.5,5.5) {0}; \node at (2.5,5.5) {0}; \node at (3.5,5.5) {0}; \node at (4.5,5.5) {0}; \node at (5.5,5.5) {0};
    \draw[->,thick] (3.2, 4.5) -- (5.2, 4.5);
  \end{scope}
  \begin{scope}[xshift=22cm,yshift=1.5cm]
    \draw[black,thick] (0,0) grid (3,3);
    \draw[black,very thick] (0,0) rectangle (3,3);
    % Add numerical values for tensor filter
    \node at (0.5,0.5) {0}; \node at (1.5,0.5) {1}; \node at (2.5,0.5) {0};
    \node at (0.5,1.5) {0}; \node at (1.5,1.5) {0}; \node at (2.5,1.5) {0};
    \node at (0.5,2.5) {0}; \node at (1.5,2.5) {1}; \node at (2.5,2.5) {0};
    \node[left] at (0,1.5) {tensor filter};
  \end{scope}
  \begin{scope}[xshift=28cm]
    \draw[black,thick] (0,0) grid (6,6);
    \draw[black,very thick] (0,0) rectangle (6,6);
    % Add numerical values for final output
    \node at (0.5,0.5) {0}; \node at (1.5,0.5) {0}; \node at (2.5,0.5) {0}; \node at (3.5,0.5) {0}; \node at (4.5,0.5) {0}; \node at (5.5,0.5) {0};
    \node at (0.5,1.5) {0}; \node at (1.5,1.5) {0}; \node at (2.5,1.5) {0}; \node at (3.5,1.5) {0}; \node at (4.5,1.5) {0}; \node at (5.5,1.5) {0};
    \node at (0.5,2.5) {0}; \node at (1.5,2.5) {0}; \node at (2.5,2.5) {4}; \node at (3.5,2.5) {0}; \node at (4.5,2.5) {0}; \node at (5.5,2.5) {0};
    \node at (0.5,3.5) {0}; \node at (1.5,3.5) {0}; \node at (2.5,3.5) {0}; \node at (3.5,3.5) {0}; \node at (4.5,3.5) {0}; \node at (5.5,3.5) {0};
