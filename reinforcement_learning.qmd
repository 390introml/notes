...
$$
where $\#(s,a,s')$ counts transitions matching $(s,a,s')$ in the data and $\#(s,a)$ counts visits to $(s,a)$. The added $1$ and $|\mathcal{S}|$ are *Laplace smoothing*: they prevent zero-probability estimates and division by zero, and their effect fades as data accumulates.
