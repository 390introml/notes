...
- **Parallel Computation**: Unlike recurrent neural networks (RNNs) that process sequences iteratively, transformers can process all tokens in a sequence simultaneously, significantly improving training efficiency.
...
- **Key vector** $k_i$: Represents the "answer" that other tokens provide to queries.
- **Value vector** $v_i$: Represents the actual information that is aggregated based on attention scores.
