...
:::{.column-margin}
Sometimes you will see the objective written as a sum instead of an average. In the "sum" convention, the $\frac{1}{n}$ normalizing constant is getting "absorbed" into individual $f_i$.
$$
